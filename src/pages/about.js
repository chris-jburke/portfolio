...
const AboutPage = () => (
	<Layout>
  		<StyledBackground>
  			<Box style={{"width":"100%", "paddingBottom":"100px","paddingTop":"125px", "height":"90%", "margin":"0 auto", "display":"flex","justifyContent":"center","alignContent":"center","alignItems":"center", "overflowY": "scroll","WebkitOverflowScrolling": "touch"}}>
  			<SEO title="Home" />
  			<Grid
   				container
   				direction="column"
