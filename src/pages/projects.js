    			...
    			>
    				...
    				<Grid style={{"display":"flex","justifyContent":"center","alignItems":"center"}}item lg={4} xs={12}>
    					<Box >
    						...
    						<Typography variant="body1" style={{"marginTop":"5px"}}><span style={{"color":"white"}}>Link to Elm Prints: </span><WhiteButton variant="outlined" size="small" href="http://elmprints.herokuapp.com/" target="_blank" rel="noopener norefferrer">here</WhiteButton></Typography>
                            <Typography variant="body1" style={{"marginTop":"5px"}}><span style={{"color":"white"}}>Link to the Github: </span><WhiteButton variant="outlined" size="small" href="https://github.com/chris-jburke/elmprints" target="_blank" rel="noopener norefferrer">here</WhiteButton></Typography>
    					</Box>
    				</Grid>
    			</Grid>
    		</Grid>
    			...
    			>
    				...
    				<Grid style={{"display":"flex","justifyContent":"center","alignItems":"center"}}item lg={4} xs={12}>
    					<Box>
                            ...
                            <Typography variant="body1" style={{"marginTop":"5px"}}><span style={{"color":"white"}}>Link to Martian Terraforming: </span><WhiteButton variant="outlined" size="small" href="http://mars-colony-game.herokuapp.com/" target="_blank" rel="noopener norefferrer">here</WhiteButton></Typography>
    						<Typography variant="body1" style={{"marginTop":"5px"}}><span style={{"color":"white"}}>Link to the Github: </span><WhiteButton variant="outlined" size="small" href="https://github.com/chris-jburke/mars-colony-game" target="_blank" rel="noopener norefferrer">here</WhiteButton></Typography>
    					</Box>
    				</Grid>
    			</Grid>
    		</Grid>
    			...
    			>
    				...
    				<Grid style={{"display":"flex","justifyContent":"center","alignItems":"center"}}item lg={4} xs={12}>
    					<Box>
    						...
    						<Typography variant="body1" style={{"marginTop":"5px"}}><span style={{"color":"white"}}>Link to Lord of Stars: </span><WhiteButton variant="outlined" size="small" href="http://lord-of-stars.herokuapp.com/" target="_blank" rel="noopener norefferrer">here</WhiteButton></Typography>
                            <Typography variant="body1" style={{"marginTop":"5px"}}><span style={{"color":"white"}}>Link to the Github: </span><WhiteButton variant="outlined" size="small" href="https://github.com/chris-jburke/project2-lord-of-stars" target="_blank" rel="noopener norefferrer">here</WhiteButton></Typography>    					
                        </Box>
    				</Grid>
    			</Grid>
    		</Grid>
                ...
                >
                    ...
                    <Grid style={{"display":"flex","justifyContent":"center","alignItems":"center"}}item lg={4} xs={12}>
                        <Box>
                            ...
                            <Typography variant="body1" style={{"marginTop":"5px"}}><span style={{"color":"white"}}>Link to Checkers: </span><WhiteButton variant="outlined" size="small" href="https://chris-jburke.github.io/project1-checkers/" target="_blank" rel="noopener norefferrer">here</WhiteButton></Typography>
                            <Typography variant="body1" style={{"marginTop":"5px"}}><span style={{"color":"white"}}>Link to the Github: </span><WhiteButton variant="outlined" size="small" href="https://github.com/chris-jburke/project1-checkers" target="_blank" rel="noopener norefferrer">here</WhiteButton></Typography>                            
                        </Box>
                    </Grid>
                </Grid>
            </Grid>
